...
Let's start by looking at the "compact sequences", perhaps the most famous 
ALTREP class in R.
...
operation actually takes suspiciously long. This is of course because a 100 million element
...
However, when the `DATAPTR` of the sequence is accessed (which is a pointer to the array of data in the vector), it forces the compact sequence to expand.
